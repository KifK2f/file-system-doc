...
L'article Wikipédia met l'accent sur la sécurité des structures de données (les métadonnées). Un crash système ou une panne de courant pendant une écriture peut corrompre le système de fichiers.

La **journalisation** résout ce problème : avant de modifier un fichier, le système écrit l'action planifiée dans une zone réservée appelée *journal*.
